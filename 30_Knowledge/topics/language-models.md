...
- [[papers/dervishi-2026-crossbert]] — **CrossBERT** (LeCun co-author): encoders, not decoders — separating representation learning from token reconstruction stops BERT's frozen features degrading with scale; frozen beats fully-finetuned at large scale.
